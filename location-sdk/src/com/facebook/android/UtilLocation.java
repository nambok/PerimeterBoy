...
public final class UtilLocation {
     ...
     * @throws MyLocationError - if an error condition is set
     */
    public static JSONObject parseJson(String response)
          throws JSONException, MyLocationError {
        // Edge case: when sending a POST request to /[post_id]/likes
        // the return value is 'true' or 'false'. Unfortunately
        // these values cause the JSONObject constructor to throw
        // an exception.
        if (response.equals("false")) {
            throw new MyLocationError("request failed");
        }
        ...
        if (json.has("error")) {
            ...
            throw new MyLocationError(
                    error.getString("message"), error.getString("type"), 0);
        }
        if (json.has("error_code") && json.has("error_msg")) {
            throw new MyLocationError(json.getString("error_msg"), "",
        ...
        if (json.has("error_reason")) {
            throw new MyLocationError(json.getString("error_reason"));
        }
        return json;
    }
